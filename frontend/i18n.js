...
const TRANSLATIONS = {
  uz: {
    ...
    checklist_type_edit_title: "Smena nomini tahrirlash",
    checklist_type_name_label: "Smena nomi",
  ...
  ru: {
    ...
    checklist_type_edit_title: "Редактировать название смены",
    checklist_type_name_label: "Название смены",
  ...
  en: {
    ...
    checklist_type_edit_title: "Edit shift name",
    checklist_type_name_label: "Shift name",
